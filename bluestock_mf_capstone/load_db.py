...
def load_star_schema():
    ...
    df_nav = pd.read_csv(os.path.join(PROCESSED_DIR, "nav_history.csv"))
    df_tx = pd.read_csv(os.path.join(PROCESSED_DIR, "investor_transactions.csv"))
    ...
    # 6. Load fact_aum
    df_aum = pd.read_csv(os.path.join(PROCESSED_DIR, "aum_by_fund_house.csv"))
    ...
    df_sip = pd.read_csv(os.path.join(PROCESSED_DIR, "monthly_sip_inflows.csv"))
    df_sip.to_sql("monthly_sip_inflows", engine, if_exists="replace", index=False)
    
    df_cat = pd.read_csv(os.path.join(PROCESSED_DIR, "category_inflows.csv"))
    df_cat.to_sql("category_inflows", engine, if_exists="replace", index=False)
    
    df_folio = pd.read_csv(os.path.join(PROCESSED_DIR, "industry_folio_count.csv"))
    ...
    df_bench = pd.read_csv(os.path.join(PROCESSED_DIR, "benchmark_indices.csv"))
